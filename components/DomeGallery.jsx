...
export default function DomeGallery({
  ...
  const step = () => {
    ...
    const nextY = wrapAngleSigned(rotationRef.current.y + autoSpeed);
...
const rawIcon = parent.dataset.icon || '';
  ...
  return (
    <>
      ...
      >
          <motion.div
              ...
              >
                ...
                <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
                  Cutting-edge solutions crafted to scale your business faster.
                </p>
              </motion.div>
        ...
        <main
          ref={mainRef}
          className="absolute mt-40 inset-0 grid place-items-center overflow-hidden select-none bg-transparent"
          style={{
            touchAction: 'none',
            ...
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                <div
                  ...
                  data-src={it.src}
                  data-alt={it.alt}
                  data-title={images[i % images.length]?.title || ""}
                  data-desc={images[i % images.length]?.desc || ""}
                  data-icon={images[i % images.length]?.icon || ""}
                  data-offset-x={it.x}
                  data-offset-y={it.y}
