...
const GlassSurface = dynamic(() => import("@/src/components/GlassSurface"), {
  ssr: false,
});
...
export interface RotatingTextProps extends MotionProps {
  texts: string[];
          ...
          {elements.map((wordObj, wordIndex, array ) => {
            ...
            return (
                    ...
                    className={`
                      ...
                      `}
                    >
                      <span  className={cn('inline-flex  bg-black/10    px-10', splitLevelClassName)}>
